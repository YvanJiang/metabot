---
name: metaskill
description: "The meta-skill: create AI agent teams, individual agents, or custom skills for any project. Use when the user wants to generate a complete .codex/ agent team, create a single agent, or create a single skill."
user-invocable: true
...
Skill base: !`for d in "$HOME/.codex/skills/metaskill" ".codex/skills/metaskill"; do [ -d "$d/flows" ] && echo "$d" && break; done 2>/dev/null || echo "$HOME/.codex/skills/metaskill"`
