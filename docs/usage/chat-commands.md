...
| `/codexbot` | Load Agent Bus docs (scheduling, bot management, cross-instance talk) |
...
- `/metaskill` and `/codexbot` are skills that get loaded into Claude's context on demand
